...
if not os.path.exists(file_path):
    ...
    # Pastikan kolom 'product_type' ada di dataset
    if 'product_type' in all_df.columns:
        # Sidebar untuk filter
        st.sidebar.header("Filters")
        product_type = st.sidebar.multiselect("Pilih Jenis Produk", options=all_df['product_type'].unique(), default=all_df['product_type'].unique())
        ...
        st.error("Kolom 'product_type' tidak ditemukan di dataset.")
